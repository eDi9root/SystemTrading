# Save the FID CODE list used to obtain
# real-time information in dictionary form in korean
...
# A function that finds the FID of the item name you are looking for.
